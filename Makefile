...
APPNAME=mtb-example-threadx-cyw5591x-low-power
...
DEFINES += DEFAULT_TCP_WINDOW_SIZE=19110
DEFINES += DEFAULT_IPERF_SERVER_TIMEOUT_SEC=30
# Add additional defines to the build process (without a leading -D).
DEFINES+=CY_RTOS_AWARE CY_RETARGET_IO_CONVERT_LF_TO_CRLF HAVE_SNPRINTF
